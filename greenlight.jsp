                    ...
                    <div class="" style="margin-top: -60px;">
                        <div class="col-md-12">
                            ...
                            <div class="pull-right" style="margin:-20px 20px;color:#b70025;font-style:italic;font-size:14px;font-weight:600;display: inline-flex;">
                                ...
                                <a id="exceldownload" style="font-size: 25px;color: #337ab7;border-radius: 2px;padding: 3px;
...
var aa=$("#platformlist").val();
                            ...
                            if ($(e.target).select2('val')[0].toLowerCase().trim() ==="" && $(e.target).select2('val').length > 1) {
                                $("#platformlist").val([$(e.target).select2('val')[1]]).trigger("change");
                                $($(e.params.originalEvent.currentTarget).siblings()[0]).attr('aria-selected', 'false');
                            }*/
                        ...
                        if ($("#year2016").val().length == 0) {
                            ...
                            sendRequest("/thk/saveGreenLight", {
                                "data": {
                                    ...
                                    "platformId": $("#programlist").val(),
                                    "y1": $("#year2016").autoNumeric('get'),
                                    "y2": $("#year2017").autoNumeric('get'),
                                    "y3": $("#year2018").autoNumeric('get'),
                                    "y4": $("#year2019").autoNumeric('get'),
                                    "y5": $("#year2020").autoNumeric('get'),
                                    "y6": $("#year2021").autoNumeric('get'),
                                    "total": $("#amount").autoNumeric('get')
                                }
                            }, function(e) {
                                console.log(e.data)
                                if (e.data == 1) {
